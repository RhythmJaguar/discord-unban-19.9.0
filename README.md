...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/RhythmJaguar/">RhythmJaguar</a><a href="https://github.com/RhythmJaguar/discord-unban-19.9.0">/discord-unban-19.9.0</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
...
<!-- gbzap-brand-lead -->
**Скачать discord-unban-19.9.0** — запрет Discord (голос / RTC) без VPN. Актуальная сборка в [Releases](./releases/latest).

> [!CAUTION]
>
> ### ФЕЙКИ
> Я не веду никакие другие страницы/группы в телеграм/ютуб каналы  
> Если вы наткнулись на что-то вне репозитория `RhythmJaguar/discord-unban-19.9.0`, что распространяется от моего лица - **ФЕЙК**.
...
> [!IMPORTANT]
> Все бинарные файлы в папке [`bin`](./bin) взяты из [zapret-win-bundle/zapret-winws](https://github.com/bol-van/zapret-win-bundle/tree/master/zapret-winws) и [zapret/releases](https://github.com/RhythmJaguar/discord-unban-19.9.0/releases/latest). Вы можете это проверить с помощью хэшей/контрольных сумм. Проверяйте, что запускаете, используя сборки из интернета!
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/RhythmJaguar/discord-unban-19.9.0/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/RhythmJaguar/discord-unban-19.9.0/issues/522)
...
- См. [#765](https://github.com/RhythmJaguar/discord-unban-19.9.0/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/RhythmJaguar/discord-unban-19.9.0/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/RhythmJaguar/discord-unban-19.9.0/discussions/251)
...
- См. также [#252](https://github.com/RhythmJaguar/discord-unban-19.9.0/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/RhythmJaguar/discord-unban-19.9.0/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/RhythmJaguar/discord-unban-19.9.0/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/RhythmJaguar/discord-unban-19.9.0/blob/main/LICENSE.txt)

## 🩷Благодарность участникам проекта

](https://github.com/RhythmJaguar/discord-unban-19.9.0/graphs/contributors)
